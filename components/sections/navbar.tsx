...
export default function Navbar() {
  return (
    <nav className="flex items-center bg-navy-muted lg:absolute lg:min-h-screen lg:w-[6.4375rem] lg:flex-col lg:rounded-r-[1.25rem]">
      ...
      <div className="border-l border-navy-muted-dark p-5 pl-6 sm:p-6 sm:pl-8 lg:border-l-0 lg:border-t lg:px-8 lg:py-6">
        <Image
          src={avatar}
          alt="Avatar"
